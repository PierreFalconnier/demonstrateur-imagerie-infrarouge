...
class MyResize(object):
    ...
    """
    def __init__(self) -> None:
        self.TrResize = Resize(size = (240,240))
...
class MyRandomAffine():
    def __init__(self) -> None:
        self.proba = 0.7
        self.TrRandomAffine = RandomAffine(degrees=20, translate=(0.5, 0.5), scale=(0.5,1.5))  # possible d'ajouter scale, possède pas d'arugment rotation
